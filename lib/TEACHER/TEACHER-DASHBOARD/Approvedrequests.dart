...
class TeacherApprovedRequests extends StatefulWidget {
  const TeacherApprovedRequests({super.key});

  @override
  State<TeacherApprovedRequests> createState() => _TeacherApprovedRequestsState();
}

class _TeacherApprovedRequestsState extends State<TeacherApprovedRequests> {
  List<TeacherApplyModel> allapplication = [];
  void getApplications() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection("Teacher-Approved-Applications")
        .get();
